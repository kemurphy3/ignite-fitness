...
async function testPersonalizedCoaching() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            const contextAnalysis = window.PersonalizedCoaching.analyzeUserMessage("I'm feeling stressed and tired");
            ...
            const scenario = window.PersonalizedCoaching.determineCoachingScenario(testContext, { intent: 'help' });
...
async function testCoachingEngineIntegration() {
    ...
    try {
        if (typeof window.CoachingEngine !== 'undefined') {
            ...
            const response = await window.CoachingEngine.processUserInput("Hello, I need help with my workout");
...
async function testPersonalityTraits() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            if (personality.tone === 'casual_competent' && personality.style === 'encouraging_supportive') {
                aiCoachingTestResults.passed++;
            ...
            const encouragingResponse = window.PersonalizedCoaching.generateResponse("I'm struggling with motivation");
            if (encouragingResponse.success && (encouragingResponse.response.includes('awesome') || encouragingResponse.response.includes('great'))) {
                aiCoachingTestResults.passed++;
...
async function testContextAwareness() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            if (missedWorkoutsResponse.success && 
...
async function testSafetyGuardrails() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            const injuryResponse = window.PersonalizedCoaching.generateResponse("My knee hurts when I squat");
            ...
            const medicalResponse = window.PersonalizedCoaching.generateResponse("I have a medical condition");
...
async function testResponseQuality() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            const technicalResponse = window.PersonalizedCoaching.generateResponse("What is a deload week?");
...
async function testMessageAnalysis() {
    ...
    try {
        if (typeof window.PersonalizedCoaching !== 'undefined') {
            ...
            const keywords = window.PersonalizedCoaching.extractKeywords("I need help with my workout and nutrition");
...
function displayAICoachingTestResults() {
    ...
    const passRate = totalTests > 0 ? (aiCoachingTestResults.passed / totalTests * 100).toFixed(1) : 0;

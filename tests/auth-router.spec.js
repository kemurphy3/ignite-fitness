...
const AuthManager = require('../js/modules/auth/AuthManager.js').default || require('../js/modules/auth/AuthManager.js');
const Router = require('../js/modules/ui/Router.js').default || require('../js/modules/ui/Router.js');
...
describe('Auth Router Integration Tests', () => {
    ...
    describe('2. Bad token → cleared → on #/login', () => {
        ...
        test('should clear expired token (>30 days)', async () => {
            ...
            localStorage.setItem('ignitefitness_current_user', 'testuser');
            localStorage.setItem('ignitefitness_users', JSON.stringify({

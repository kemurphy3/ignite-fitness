...
describe('UserDataRetentionManager', () => {
    ...
    describe('Error Handling', () => {
        it('should handle database errors gracefully', async () => {
            ...
            await expect(errorManager.deleteOldActivities(userId, cutoffDate))
                .rejects.toThrow('Failed to delete old activities');
        });

        it('should handle missing user ID', async () => {
            await expect(retentionManager.processDataRetention(null))
    ...
    describe('Audit Trail', () => {
        it('should log retention process', async () => {
            ...
            await expect(retentionManager.logRetentionProcess(userId, results))

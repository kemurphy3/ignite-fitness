...
describe('WorkoutGenerator Muscle Group Rotation', () => {
  ...
  describe('Muscle Group Rotation', () => {
    ...
    it('should fallback to deterministic selection when no different muscle groups available', () => {
      const userProfile = {
        ...
        recentWorkouts: [
          {
            exercises: [{ name: 'Bench Press', muscleGroups: ['chest', 'shoulders', 'triceps'] }],
          },
        ],
      };
  ...
  describe('Upper Body / Lower Body Rotation', () => {
    it('should automatically rotate between upper and lower body workouts', () => {
      ...
      const upperResult = workoutGenerator.selectBestExercise(
        lowerExercises,
        upperBodyProfile,
        'quadriceps'
      );
      ...
      const lowerResult = workoutGenerator.selectBestExercise(
        upperExercises,
        lowerBodyProfile,
        'chest'
      );

...
describe('WhyPanel Component', () => {
    ...
    describe('Override Functionality', () => {
        ...
        it('should select alternate exercise', () => {
            ...
            expect(window.WorkoutTracker.currentPlan.blocks[0].items[0].notes).toContain('Overridden from Squat');
        ...
        it('should apply regression (reduce sets)', () => {
            ...
            expect(window.WorkoutTracker.currentPlan.blocks[0].items[0].notes).toContain('Regression applied');
            expect(renderSpy).toHaveBeenCalled();
        });
        ...
        it('should apply progression (increase sets)', () => {
            ...
            expect(window.WorkoutTracker.currentPlan.blocks[0].items[0].notes).toContain('Progression applied');
            expect(renderSpy).toHaveBeenCalled();
        });
    ...
    describe('Event Logging', () => {
        it('should log override events', () => {
            ...
            expect(window.StorageManager.saveSessionLog).toHaveBeenCalledWith(
                'testuser',
                '2024-01-01',

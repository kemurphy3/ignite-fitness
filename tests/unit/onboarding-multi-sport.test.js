...
describe('Enhanced Multi-Sport Onboarding', () => {
  describe('SportSelection', () => {
    it('should render sport selection step', async () => {
      ...
      const SportSelection =
        module.default || module.SportSelection || window.SportSelection?.constructor;
  ...
  describe('CurrentVolume', () => {
    it('should render volume input step', async () => {
      ...
      const CurrentVolume =
        module.default || module.CurrentVolume || window.CurrentVolume?.constructor;
  ...
  describe('EquipmentAccess', () => {
    it('should render equipment access step', async () => {
      ...
      const EquipmentAccess =
        module.default || module.EquipmentAccess || window.EquipmentAccess?.constructor;
  ...
  describe('SecondarySports', () => {
    it('should render secondary sports step', async () => {
      ...
      const SecondarySports =
        module.default || module.SecondarySports || window.SecondarySports?.constructor;
  ...
  describe('RecentEfforts', () => {
    it('should render recent efforts step', async () => {
      ...
      const RecentEfforts =
        module.default || module.RecentEfforts || window.RecentEfforts?.constructor;
  ...
  describe('InjuryHistory', () => {
    it('should render injury history step', async () => {
      ...
      const InjuryHistory =
        module.default || module.InjuryHistory || window.InjuryHistory?.constructor;
  ...
  describe('ReviewComplete', () => {
    it('should render review step', async () => {
      ...
      const ReviewComplete =
        module.default || module.ReviewComplete || window.ReviewComplete?.constructor;
  ...
  describe('OnboardingManager validation', () => {
    it('should validate required onboarding data', async () => {
      ...
      const OnboardingManager =
        module.default || module.OnboardingManager || window.OnboardingManager?.constructor;

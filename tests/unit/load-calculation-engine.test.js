...
describe('LoadCalculationEngine', () => {
  describe('compute_load - Pure Function Behavior', () => {
    ...
    it('should throw error for invalid input', () => {
      ...
      expect(() => LoadCalculationEngine.compute_load(undefined)).toThrow(
        'Session object is required'
      );
      expect(() => LoadCalculationEngine.compute_load('string')).toThrow(
        'Session object is required'
      );
      expect(() => LoadCalculationEngine.compute_load({})).toThrow(
        'Insufficient data for load calculation'
      );
    });
  });
  ...
  describe('Zone-Based Load Calculation', () => {
    it('should calculate load from zone distribution', () => {
      ...
      // Z1: 10 * 0.5 = 5, Z2: 40 * 2.0 = 80, Z3: 10 * 4.0 = 40, Total: 125
      expect(result.total_load).toBe(125);

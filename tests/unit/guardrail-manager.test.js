...
describe('GuardrailManager', () => {
    ...
    describe('Initialization', () => {
        ...
        it('should have ramp rate limits', () => {
            ...
            expect(rates.load).toBe(0.10); // 10%
            expect(rates.volume).toBe(0.10); // 10%
    ...
    describe('validateWorkout', () => {
        it('should return validation result structure', async () => {
            const workout = {
                estimatedLoad: 50,
                structure: [
                    { type: 'main', duration: 1800, intensity: 'Z3' }
                ]
            };
        ...
        it('should block workout exceeding weekly load cap', async () => {
            const workout = {
                estimatedLoad: 400,
                structure: [
                    { type: 'main', duration: 3600, intensity: 'Z4' }
                ]
            };

            const userProfile = { trainingLevel: 'intermediate' };
            const recentSessions = [
                { date: new Date(), calculatedLoad: 350 }
            ];
            const readinessData = {};
        ...
        it('should warn about excessive ramp rate', async () => {
            const workout = {
                estimatedLoad: 250,
                structure: [
                    { type: 'main', duration: 2400, intensity: 'Z4' }
                ]
            };
        ...
        it('should suggest deload after 4 weeks', async () => {
            const workout = {
                estimatedLoad: 60,
                structure: [
                    { type: 'main', duration: 2000, intensity: 'Z3' }
                ]
            };
    ...
    describe('checkWeeklyLoadCap', () => {
        it('should pass for workout within weekly cap', () => {
            ...
            const userProfile = { trainingLevel: 'intermediate' };
            const recentSessions = [
                { date: new Date().toISOString(), calculatedLoad: 200 }
            ];
        ...
        it('should fail for workout exceeding weekly cap', () => {
            ...
            const userProfile = { trainingLevel: 'intermediate' };
            const recentSessions = [
                { date: new Date().toISOString(), calculatedLoad: 350 }
            ];
        ...
        it('should check hard minutes cap', () => {
            const workout = {
                estimatedLoad: 50,
                structure: [
                    { type: 'main', sets: 10, work: { duration: 60, intensity: 'Z5' } }
                ]
            };
    ...
    describe('applyAutoAdjustments', () => {
        it('should apply load reduction', () => {
            const workout = {
                estimatedLoad: 100,
                structure: [
                    { type: 'main', sets: 10, work: { duration: 60, intensity: 'Z4' } }
                ]
            };
        ...
        it('should apply intensity reduction', () => {
            const workout = {
                estimatedLoad: 80,
                structure: [
                    { type: 'main', duration: 2400, intensity: 'Z5' }
                ]
            };

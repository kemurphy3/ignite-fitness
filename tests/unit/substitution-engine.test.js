...
describe('SubstitutionEngine', () => {
  ...
  describe('generateReasoning', () => {
    it('should generate clear reasoning for substitutions', () => {
      ...
      const reasoning = substitutionEngine.generateReasoning(originalSession, substitution, 100);
...
describe('EquivalenceRules', () => {
  ...
  describe('checkAdaptationCompatibility', () => {
    it('should match exact adaptations', () => {
      const result = EquivalenceRules.checkAdaptationCompatibility('aerobic_base', 'aerobic_base');

      expect(result.compatible).toBe(true);
      expect(result.match).toBe('exact');
      expect(result.confidence_bonus).toBe(0.1);
    });

    it('should match compatible adaptations', () => {
      const result = EquivalenceRules.checkAdaptationCompatibility('aerobic_base', 'endurance');

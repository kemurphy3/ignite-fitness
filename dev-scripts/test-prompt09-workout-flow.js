...
Object.assign(window.testPrompts09, {
  ...
  testStartButton() {
    ...
    console.assert(button.className === 'btn-start-large', 'Should have large button class');
    console.assert(button.style.width === '100%', 'Should be full width');
    console.assert(button.style.height === '80px', 'Should be large tap target (80px)');
    console.assert(button.innerHTML.includes('Start Workout'), 'Should show "Start Workout" text');
  ...
  testGracefulResume() {
    ...
    console.assert(
      resumeResult.totalElapsed > sessionState.sessionStartTime,
      'Should track total elapsed time'
    );

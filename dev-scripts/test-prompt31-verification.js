...
class Prompt31Verification {
  ...
  testQuickExerciseSwap() {
    ...
    if (typeof wt.swapExercise === 'function' || typeof wt.suggestAlternative === 'function') {
  ...
  testOfflineCapability() {
    ...
    if (wt.storageManager) {
      this.results.passed.push(
        'WorkoutTracker integrates with StorageManager for offline capability'
      );
    }

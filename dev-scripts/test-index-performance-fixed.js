...
async function testIndexPerformance() {
  ...
  try {
    ...
    console.log('\n💡 Next Steps:');
    console.log(
      "1. Check index usage: SELECT * FROM pg_stat_user_indexes WHERE schemaname = 'public';"
    );
    console.log(
      "2. Verify indexes exist: SELECT indexname FROM pg_indexes WHERE schemaname = 'public';"
    );

...
class Prompt51Verification {
  ...
  testBMRCalculation() {
    ...
    if (document.querySelector('script[src*="nutrition-calculator"]')) {
      ...
      this.results.warnings.push(
        'nutrition-calculator.js not loaded (normal for Netlify function)'
      );
    }
  ...
  testNoFoodLogging() {
    ...
    const foodLoggingElements = document.querySelectorAll(
      '.food-log, .meal-tracker, .calorie-counter'
    );

!(function () {
  ...
  const a = window.SafeLogger || console;
  let o = null,
    r = !1,
    s = {},
    i = null,
  ...
  async function p(e, t, o = {}) {
    ...
    try {
      const a = (async () => {
        const a = new (await n(776)(e))[t]();
        return (u.set(r, a), a);
      })();
      m.set(r, a);
      const s = await a;
      return (m.delete(r), o.showLoading && w(), s);
    } catch (n) {
      throw (
        a.error('Failed to load module', {
          modulePath: e,
          className: t,
          error: n.message,
          stack: n.stack,
  ...
  function f() {
    const e = '2.0',
      t = localStorage.getItem('ignitefitness_data_version');
    t !== e &&
      (a.info('Migrating user data', { fromVersion: t || '1.0', toVersion: e }),
      (t && '1.0' !== t) ||
        (function () {
          try {
            ...
            if (e) {
              ...
              (Object.keys(t).forEach(e => {
                ...
                n[e] = {
                  ...
                  goals: a.goals || {},
                  workoutSchedule: a.workoutSchedule || {},
                  sessions: a.sessions || [],
                  preferences: a.preferences || {},
                  lastSync: a.lastSync || Date.now(),
            ...
            (!(function () {
              const e = localStorage.getItem('strava_access_token'),
                ...
                a = localStorage.getItem('strava_athlete_id');
              if (e && t) {
                const o = {
                  access_token: e,
                  refresh_token: t,
                ...
                (localStorage.setItem('ignitefitness_strava_data', JSON.stringify(o)),
              ...
              (function () {
                ...
                if (e)
                  try {
                    ...
                    a.error('Error migrating workout data', { error: e.message, stack: e.stack });
                  }
              })());
          } catch (e) {
            a.error('Error during data migration', { error: e.message, stack: e.stack });
          }
        })(),
      localStorage.setItem('ignitefitness_data_version', e),
      a.info('Data migration completed'));
  }
  function y() {
  ...
  function v() {
    ...
    if (e && t) {
      ...
      if (n) {
        const a = new Date(parseInt(n));
        ((t.textContent = `Last sync: ${a.toLocaleString()}`), (e.textContent = '✅ Synced'));
  ...
  if (
    (document.addEventListener('DOMContentLoaded', () => {
      (a.info('Ignite Fitness App Starting'), f());
      ...
      if (t)
        try {
          ...
          (a.error('Error parsing saved users', { error: e.message, stack: e.stack }), (s = {}));
        }
      (!(async function () {
        try {
          (await (async function () {
            try {
              ...
              ((i = e), a.info('AI system initialized'));
            } catch (e) {
              a.warn('ContextAwareAI not available', { error: e.message, stack: e.stack });
            }
          })(),
            await (async function () {
              try {
                const e = await p('./modules/data/DataStore.js', 'DataStore');
                ((l = e), l.setCurrentUser(o), a.info('Data store initialized'));
              } catch (e) {
                a.warn('DataStore not available', { error: e.message, stack: e.stack });
              }
            })(),
            await (async function () {
              try {
                const e = await p('./modules/workout/WorkoutGenerator.js', 'WorkoutGenerator');
                ((d = e), a.info('Workout generator initialized'));
              } catch (e) {
                a.warn('WorkoutGenerator not available', { error: e.message, stack: e.stack });
              }
            })(),
            await (async function () {
              try {
                const e = await p('./modules/ai/PatternDetector.js', 'PatternDetector');
                ((g = e), a.info('Pattern detector initialized'));
              } catch (e) {
                a.warn('PatternDetector not available', { error: e.message, stack: e.stack });
              }
            })(),
            a.info('Core systems initialized successfully'));
        } catch (e) {
          (a.error('Failed to initialize core systems', { error: e.message, stack: e.stack }),
        ...
        [
          ...
          p(e, t, { showLoading: !1 }).catch(e =>
            a.warn('Preload failed', { className: t, error: e.message, stack: e.stack })
          );
        }),
        (function () {
              ...
              const r = a
                .map(e => {
                  ...
                  const n = new Date(e.start_at).toLocaleDateString(),
                    a = e.duration || 'Unknown',
                    o = (null === (t = e.exercises) || void 0 === t ? void 0 : t.length) || 0;
                  return `\n            <div class="workout-item">\n                <div class="workout-info">\n                    <h6>${e.type || 'Workout'}</h6>\n                    <p>${n}</p>\n                </div>\n                <div class="workout-stats">\n                    <span>${a} min</span>\n                    <span>${o} exercises</span>\n                </div>\n            </div>\n        `;
                })
                .join('');
              n.innerHTML = r;
            })())
              ...
              (E(t, 'user'),
                ...
                i
                  ? i
                      ...
                      .catch(e => {
                        (D(),
                          E('Sorry, I encountered an error. Please try again.', 'ai'),
                          a.error('AI Error', { error: e.message, stack: e.stack }));
                      })
                  : (D(), E('AI system is not available. Please try again later.', 'ai')));
            })();
        }),
        a.info('Ignite Fitness App Ready'));
    }),
  ...
  function S() {
    const e = localStorage.getItem('strava_access_token'),
      ...
      n = localStorage.getItem('strava_token_expires'),
      a = localStorage.getItem('strava_athlete_id'),
      o = document.getElementById('stravaStatus'),
      r = document.getElementById('stravaConnectBtn'),
      s = document.getElementById('stravaDisconnectBtn'),
      i = document.getElementById('stravaSyncBtn');
    if (!e || !t || !n)
      return (
        (o.className = 'device-status disconnected'),
        (o.innerHTML = '<p>❌ Not connected to Strava</p>'),
  ...
  async function b() {
    ...
    if (e)
      try {
        ...
        (a.error('Token refresh failed', { error: e.message, stack: e.stack }),
          localStorage.removeItem('strava_access_token'),
          localStorage.removeItem('strava_refresh_token'),
          localStorage.removeItem('strava_token_expires'),
          localStorage.removeItem('strava_athlete_id'),
          S(),
          I('Disconnected from Strava'));
      }
    else S();
  }
  function E(e, t) {
...
//# sourceMappingURL=main.1562223c7f4c2511f6de.js.map

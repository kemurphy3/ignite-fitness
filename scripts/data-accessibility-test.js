...
class DataAccessibilityTester {
  ...
  validateChartDescriptions() {
    const hasChartDescriptions = this.checkFileContains(
      'js/modules/ui/charts/Trends.js',
      'generateChartDescription'
    );
    const hasDataTables = this.checkFileContains(
      'js/modules/ui/charts/Trends.js',
      'createDataTable'
    );
    ...
    return {
      ...
      details:
        hasChartDescriptions && hasDataTables ? null : 'Charts missing descriptions or data tables',
    };
  }
  ...
  validateKeyboardNavigation() {
    const hasKeyboardNav = this.checkFileContains(
  ...
  validateChartControls() {
    const hasChartKeyboard = this.checkFileContains(
      'js/modules/ui/charts/Trends.js',
  ...
  validateSemanticStructure() {
    ...
    return {
      ...
      details:
        hasSemanticHTML && hasSkipLinks && hasLandmarks ? null : 'Missing semantic HTML structure',
    };
  }

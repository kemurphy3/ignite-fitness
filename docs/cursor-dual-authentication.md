...
## Overview
Make the app accessible to everyone, not just Strava users. Implement email/password authentication alongside the existing Strava OAuth.
...
<div id="auth-container" class="auth-container">
  ...
  <div id="forgot-form" class="auth-form">
    ...
    <a href="#" onclick="showAuthTab('login')" class="back-link">Back to login</a>
  </div>
  ...
  <div id="reset-form" class="auth-form">
    ...
    <form onsubmit="handleResetPassword(event)">
      <input type="password" id="reset-password" placeholder="New Password (8+ characters)" required minlength="8">
      <input type="password" id="reset-password-confirm" placeholder="Confirm New Password" required>

...
✅ Reasons include: game timing, readiness inference, injury flags, goal
priorities, time limits, user dislikes  
...
- `generateWhyToday(block, context)` - Generates "Why This Today?" for each
  block
...
**Summary**: Transparency layer builds trust by always showing short reasons for
every exercise and adjustment.
...
**Users now always know "Why This Today?" - building trust through
transparency.** 💡

...
<div class="weight-display">
  ...
  <!-- Optional fallback -->
  <div class="weight-fallback">
    💡 If missing plates, use 135 lb and add 2-3 reps
  </div>
</div>
```
...
1. **Practical Instructions**: Shows real plate loading instead of decimal
   weights

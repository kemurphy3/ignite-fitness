...
**npm cleaned up and reorganized your dependency tree.** This is **normal and
beneficial**.
...
When multiple packages need the same dependency, npm puts ONE copy at the root
instead of multiple copies nested in each package.
...
This is **100% normal and beneficial**. npm is just being smart about organizing
your dependencies!

...
class Prompt41Verification {
    ...
    test4WeekBlockStructure() {
        ...
        if (typeof sp.generateMicrocycle === 'function') {
            ...
            if (block.weeks.length === 4) {
                ...
                if (week2.volumeMultiplier > week1.volumeMultiplier && 
    ...
    testCompetitionCalendar() {
        ...
        if (document.querySelector('script[src*="periodization-planner"]')) {
            ...
            this.results.warnings.push('periodization-planner.js not loaded (normal for Netlify function)');
        }
    }
    ...
    testAdaptiveBlocks() {
        ...
        if (window.ProgressionEngine && typeof window.ProgressionEngine.shouldForceDeload === 'function') {
        ...
        if (window.ProgressionEngine && typeof window.ProgressionEngine.shouldSkipDeload === 'function') {

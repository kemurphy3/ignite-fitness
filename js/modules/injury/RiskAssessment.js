...
class RiskAssessment {
    ...
    generateRecommendations(riskLevel, userData, sportId) {
        ...
        if (userData.sleep < 6) {
            recommendations.push({
                ...
                priority: 'high',
                actions: ['Improve sleep hygiene', 'Create sleep schedule', 'Reduce screen time before bed']
            });
        }
    ...
    getTrendRecommendation(trend) {
        const recommendations = {
            increasing: 'Injury risk is increasing. Consider reducing training load and increasing recovery.',

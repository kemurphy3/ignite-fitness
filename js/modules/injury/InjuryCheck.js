...
class InjuryCheck {
  ...
  getSafeModifications(bodyLocation, painLevel) {
    ...
    const rules = {
      knee: {
        high: {
          ...
          message:
            'For knee discomfort, try lighter loads and focus on hip and glute strengthening.',
        },
        moderate: {
          // pain 4-6
      ...
      shoulder: {
        high: {
          ...
          message:
            'For shoulder discomfort, avoid overhead movements and focus on posterior delt work.',
        },
        moderate: {
    ...
    return {
      ...
      ...rule,
      educationalNote:
        '⚠️ These are exercise suggestions only, not medical advice. Consult a healthcare professional if pain persists.',
    };
  }
  ...
  checkExerciseModifications(exerciseName) {
    ...
    const recentPain = this.painReports.find(
      report =>

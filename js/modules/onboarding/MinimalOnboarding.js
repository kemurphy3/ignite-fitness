...
class MinimalOnboarding {
    ...
    toggleSecondarySport(checkbox) {
        ...
        if (checkbox.checked) {
            ...
            this.onboardingData.secondary_sports = this.onboardingData.secondary_sports.filter(s => s !== sport);
        }
    }
    ...
    toggleEquipment(checkbox) {
        ...
        if (checkbox.checked) {
            ...
            this.onboardingData.equipment_access = this.onboardingData.equipment_access.filter(e => e !== equipment);
        }
    }
    ...
    async saveOnboardingData() {
        const userId = this.authManager?.getCurrentUserId() || this.authManager?.getCurrentUsername() || 'anonymous';

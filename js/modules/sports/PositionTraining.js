        ...
        goalkeeper: {
          modules: {
            ...
            distribution: {
              ...
              exercises: ['goal_kicks', 'throws', 'punts', 'passing_accuracy'],
              frequency: 2,
              intensity: 'moderate',
              duration: 30,
            },
            agility: {
              ...
              exercises: ['ladder_drills', 'cone_work', 'lateral_movements', 'positioning_drills'],
              frequency: 3,
              intensity: 'high',
              duration: 30,
            },
        ...
        defender: {
          modules: {
            strength_training: {
              ...
              exercises: ['squats', 'deadlifts', 'bench_press', 'pull_ups', 'plyometrics'],
              frequency: 4,
              intensity: 'high',
              duration: 60,
            },
            aerial_work: {
              ...
              exercises: ['jump_training', 'heading_drills', 'timing_practice', 'aerial_duels'],
              frequency: 3,
              intensity: 'high',
              duration: 30,
            },
        ...
        midfielder: {
          modules: {
            aerobic_capacity: {
              ...
              exercises: ['interval_training', 'tempo_runs', 'fartlek_training', 'endurance_runs'],
              frequency: 4,
            ...
            agility: {
              ...
              exercises: ['ladder_drills', 'cone_work', 'agility_courses', 'reaction_drills'],
              frequency: 3,
              intensity: 'high',
              duration: 30,
            },
            ball_work: {
              ...
              exercises: ['passing_drills', 'ball_control', 'first_touch', 'vision_training'],
              frequency: 4,
              intensity: 'moderate',
              duration: 45,
            },
        ...
        forward: {
          modules: {
            ...
            plyometrics: {
              ...
              exercises: ['jump_training', 'bounding', 'reactive_jumps', 'explosive_movements'],
              frequency: 3,
              intensity: 'high',
              duration: 30,
            },

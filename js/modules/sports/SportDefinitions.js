        ...
        return {
            soccer: {
                ...
                positions: {
                    goalkeeper: {
                        name: 'Goalkeeper',
                        primaryAttributes: ['reaction_time', 'diving_reach', 'distribution_accuracy', 'commanding_area'],
                        secondaryAttributes: ['agility', 'core_strength', 'hand_eye_coordination', 'decision_making'],
                        injuryRisks: ['finger_injuries', 'shoulder_impingement', 'knee_strain', 'back_injuries'],
                        trainingFocus: ['shot_stopping', 'distribution', 'agility', 'core_strength', 'reaction_training'],
                        physicalDemands: {
                            strength: 'high',
                            endurance: 'medium',
                            speed: 'medium',
                    ...
                    defender: {
                        name: 'Defender',
                        primaryAttributes: ['aerial_ability', 'tackling', 'positioning', 'strength', 'communication'],
                    ...
                    midfielder: {
                        ...
                        trainingFocus: ['aerobic_capacity', 'agility', 'ball_work', 'core_stability', 'endurance'],
                        physicalDemands: {
                            strength: 'medium',
                            endurance: 'very_high',
                            speed: 'medium',
                    ...
                    forward: {
                        ...
                        trainingFocus: ['sprint_training', 'plyometrics', 'finishing', 'acceleration', 'agility'],
                        physicalDemands: {
                            strength: 'medium',
                            endurance: 'medium',
                            speed: 'very_high',
            ...
            basketball: {
                ...
                positions: {
                    ...
                    shootingGuard: {
                        name: 'Shooting Guard',
                        primaryAttributes: ['shooting_accuracy', 'off_ball_movement', 'defense', 'clutch_performance'],
            ...
            running: {
                ...
                disciplines: {
                    ...
                    middleDistance: {
                        ...
                        primaryAttributes: ['lactate_tolerance', 'speed_endurance', 'tactical_awareness', 'mental_toughness'],
                        injuryRisks: ['stress_fractures', 'shin_splints', 'overuse_injuries'],
                        trainingFocus: ['speed_endurance', 'lactate_tolerance', 'tactical_training', 'mental_preparation']
                    },
                    longDistance: {
                        name: 'Long Distance',
                        primaryAttributes: ['aerobic_capacity', 'running_economy', 'mental_endurance', 'fatigue_resistance'],
                        injuryRisks: ['stress_fractures', 'itb_syndrome', 'plantar_fasciitis'],
                        trainingFocus: ['aerobic_development', 'running_economy', 'mental_training', 'injury_prevention']
                    },
                    marathon: {
                        name: 'Marathon',
                        primaryAttributes: ['aerobic_capacity', 'fatigue_resistance', 'mental_endurance', 'nutrition_strategy'],
                        injuryRisks: ['stress_fractures', 'itb_syndrome', 'dehydration', 'hyponatremia'],
                        trainingFocus: ['aerobic_development', 'fatigue_resistance', 'nutrition', 'mental_preparation']
                    }
                },
                seasons: {
                    'base_training': {

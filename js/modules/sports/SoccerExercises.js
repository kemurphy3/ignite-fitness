...
class SoccerExercises {
  ...
  renderExerciseList(container, options = {}) {
    ...
    if (position) {
      filteredExercises = filteredExercises.filter(
        ex => ex.positions && ex.positions.includes(position)
      );
    }
    ...
    if (equipment) {
      filteredExercises = filteredExercises.filter(
        ex => ex.equipment && ex.equipment.includes(equipment)
      );
    }
    ...
    if (searchTerm) {
      ...
      filteredExercises = filteredExercises.filter(
        ex =>
          ...
          (ex.instructions && ex.instructions.some(inst => inst.toLowerCase().includes(term)))
      );
    }
      ...
      agility: [
        {
          ...
          variations: ['lateral_weaving', 'backward_weaving', 'one_foot_weaving'],
        },
        {
          id: 'ladder_drills',
          ...
          progressions: ['basic_run', 'in_out', 'lateral_shuffle', 'icky_shuffle', 'carioca'],
          injuryPrevention: ['ankle_stability', 'coordination', 'proper_warm_up'],
          videoUrl: '/videos/ladder_drills.mp4',
          variations: ['single_leg_hops', 'lateral_movements', 'backward_patterns'],
        },
        {
          id: 'reaction_drills',
          ...
          variations: ['visual_cues', 'auditory_cues', 'tactile_cues'],
        },
      ],
      ball_work: [
        {
          ...
          variations: ['feet_only', 'thighs_feet', 'head_feet', 'alternating_surfaces'],
        },
        {
          id: 'wall_passing',
          name: 'Wall Passing',
          ...
          progressions: ['increase_distance', 'add_movement', 'one_touch_passing', 'add_pressure'],
          injuryPrevention: ['proper_warm_up', 'gradual_progression'],
          videoUrl: '/videos/wall_passing.mp4',
          variations: ['one_touch', 'two_touch', 'moving_passing', 'angled_passing'],
        },
        {
          id: 'cone_dribbling',
          name: 'Cone Dribbling',
          ...
          progressions: ['basic_dribbling', 'speed_dribbling', 'skill_moves', 'pressure_dribbling'],
          injuryPrevention: ['proper_warm_up', 'gradual_progression'],
          videoUrl: '/videos/cone_dribbling.mp4',
          variations: ['inside_foot', 'outside_foot', 'sole_rolls', 'step_overs'],
        },
      ],
      position_specific: {
        goalkeeper: [
          {
            ...
            variations: ['low_dives', 'high_dives', 'lateral_dives', 'reaction_dives'],
          },
          {
        ...
        defender: [
          ...
          },
          {
            ...
            variations: ['block_tackles', 'slide_tackles', 'interceptions', 'recovery_tackles'],
          },
        ],
        midfielder: [
          {
            ...
            progressions: ['short_passing', 'medium_passing', 'long_passing', 'pressure_passing'],
            injuryPrevention: ['proper_technique', 'gradual_progression'],
          ...
          },
          {
            ...
            progressions: ['easy_pace', 'moderate_pace', 'tempo_pace', 'threshold_pace'],
            injuryPrevention: ['proper_warm_up', 'gradual_progression', 'good_form'],
            videoUrl: '/videos/endurance_running.mp4',
            variations: ['steady_state', 'tempo_runs', 'fartlek', 'interval_training'],
          },
        ],
        forward: [
          {
            ...
            variations: ['inside_foot', 'laces', 'chip_shots', 'volleys'],
          },
          {
            id: 'sprint_training',
      ...
      strength: [
        {
          ...
          progressions: ['bodyweight_squats', 'goblet_squats', 'back_squats', 'front_squats'],
          injuryPrevention: ['proper_form', 'gradual_progression', 'warm_up'],
          videoUrl: '/videos/squats.mp4',
          variations: ['back_squats', 'front_squats', 'goblet_squats', 'single_leg_squats'],
        },
        {
          id: 'deadlifts',
          name: 'Deadlifts',
      ...
      conditioning: [
        {
          ...
          variations: ['sprint_intervals', 'tempo_intervals', 'fartlek', 'threshold_intervals'],
        },
      ],
    };
  }
  ...
  canPerformExercise(exercise, availableEquipment) {
    return exercise.equipment.every(
      equipment => availableEquipment.includes(equipment) || equipment === 'none'
    );
  }

...
class CompositionCalculator {
  ...
  estimateBoneDensity(input) {
    ...
    return {
      ...
      density: this.#round(density, 3),
      massKg: this.#round(boneMassKg, 2),
    };
  }

  #normalizeInput(input) {
    if (!input) {
      throw new Error('Body composition input is required');
    }
  ...
  #navyBodyFat(input) {
    ...
    return 86.01 * LOG10(input.abdomen - input.neck) - 70.041 * heightLog + 36.76;
  }

    ...
    initializeMovementScreens() {
        return {
            ...
            inline_lunge: {
                ...
                corrective_exercises: {
                    knee_valgus: [
                        'hip_adductor_stretch',
                        'glute_med_strengthening',
                        'lateral_band_work'
                    ],
                    poor_hip_extension: [
                        'hip_flexor_stretch',
            ...
            shoulder_mobility: {
                ...
                corrective_exercises: {
                    ...
                    'asymmetry': [
                        'single_side_corrective_work',
                        'asymmetric_stretching',
                        'manual_therapy'
                    ]
                },
                instructions: [
            ...
            deep_squat: {
                ...
                corrective_exercises: {
                    ...
                    'limited_hip_mobility': [
                        'hip_flexor_stretch',
                        'hip_circles',
                        'hip_abduction_stretch'
                    ],
                    'core_instability': [
                        'core_strengthening',
                        'anterior_chain_work',
                        'posterior_chain_work'
                    ]
                },
                instructions: [

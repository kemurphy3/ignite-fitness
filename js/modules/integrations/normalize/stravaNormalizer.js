...
class StravaNormalizer {
    ...
    static calculateRichness(stravaActivity) {
        ...
        // Heart rate data (+0.4)
        if (stravaActivity.has_heartrate || stravaActivity.average_heartrate || stravaActivity.max_heartrate) {
            score += 0.4;
        }
    ...
    static validateNormalizedActivity(normalizedActivity) {
        ...
        if (normalizedActivity.avgHr && (normalizedActivity.avgHr < 40 || normalizedActivity.avgHr > 220)) {

...
class CoachingEngine {
    ...
    getExerciseRecommendations(userProfile) {
        ...
        const exerciseSets = {
            strength: {
                ...
                advanced: ['Bench Press', 'Squats', 'Deadlifts', 'Overhead Press', 'Rows', 'Pull-ups', 'Dips']
            },
            endurance: {
                beginner: ['Push-ups', 'Squats', 'Plank', 'Lunges', 'Burpees'],
                intermediate: ['Push-ups', 'Squats', 'Lunges', 'Burpees', 'Mountain Climbers', 'Jumping Jacks'],
                advanced: ['Burpees', 'Mountain Climbers', 'Jumping Jacks', 'High Knees', 'Jump Squats', 'Plank Jacks']
            },
            speed: {
                beginner: ['Sprints', 'Agility Ladder', 'Jump Rope', 'High Knees', 'Butt Kicks'],
                intermediate: ['Sprints', 'Agility Ladder', 'Jump Rope', 'High Knees', 'Butt Kicks', 'Lateral Shuffles'],
                advanced: ['Sprints', 'Agility Ladder', 'Jump Rope', 'High Knees', 'Butt Kicks', 'Lateral Shuffles', 'Plyometric Jumps']
            }
        };
    ...
    getSeasonalMessage() {
        try {
            ...
            const phaseMessages = {
                'off-season': 'Perfect time to build strength and work on weaknesses. Focus on fundamentals.',
                'pre-season': 'Time to ramp up intensity and sport-specific training. Get ready for competition!',
    ...
    getQuickActionResponse(action) {
        const responses = {
            injury: 'I understand you\'re dealing with an injury. Let\'s adjust your workout to focus on safe, modified exercises that won\'t aggravate the injury. What specific area is affected?',
            fatigue: 'Feeling fatigued is normal, especially after intense training. Let\'s focus on recovery - light movement, proper nutrition, and adequate sleep. Consider taking an extra rest day.',
            goals: 'Great! Changing goals is part of the journey. What new goals are you considering? I can help adjust your training plan accordingly.',
            schedule: 'Let\'s work on your workout schedule. What days work best for you? I can help create a realistic plan that fits your lifestyle.'
        };

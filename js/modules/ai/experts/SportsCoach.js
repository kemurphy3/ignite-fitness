...
class SportsCoach {
    constructor() {
        ...
        this.vo2MaxZones = {
            ...
            Z3: { min: 0.70, max: 0.80, name: 'Aerobic Threshold', description: 'Moderate effort, sustainable' },
            Z4: { min: 0.80, max: 0.90, name: 'Lactate Threshold', description: 'Hard but controlled' },
            Z5: { min: 0.90, max: 1.00, name: 'VO₂ Max', description: 'Maximum effort intervals' }
        };
    }

...
class ClimbingCoach {
    ...
    initializeClimbingExercises() {
        return {
            gripStrength: [
                { name: 'Hangboard - Open Hand', difficulty: 'beginner', grip: 'open', muscles: ['forearms', 'fingers'] },
                { name: 'Hangboard - Half Crimp', difficulty: 'intermediate', grip: 'half_crimp', muscles: ['forearms', 'fingers'] },
                { name: 'Hangboard - Full Crimp', difficulty: 'advanced', grip: 'full_crimp', muscles: ['forearms', 'fingers'] },
                { name: 'Pinch Block Training', difficulty: 'beginner', grip: 'pinch', muscles: ['forearms', 'thumbs'] },
            ...
            fingerStrength: [
                { name: 'Campus Board - Rung Laddering', difficulty: 'advanced', type: 'power', muscles: ['forearms', 'fingers', 'shoulders'] },
                { name: 'Campus Board - Bumping', difficulty: 'advanced', type: 'power', muscles: ['forearms', 'fingers'] },
                { name: 'Hangboard - Max Hangs', difficulty: 'intermediate', type: 'strength', muscles: ['forearms', 'fingers'] },
                { name: 'Hangboard - Repeaters', difficulty: 'intermediate', type: 'endurance', muscles: ['forearms', 'fingers'] },
                { name: 'No-Hang Device Training', difficulty: 'intermediate', type: 'strength', muscles: ['forearms', 'fingers'] },
                { name: 'Finger Extensions (Rubber Bands)', difficulty: 'beginner', type: 'rehabilitation', muscles: ['fingers'] },
                { name: 'Finger Pulley Strengthening', difficulty: 'beginner', type: 'rehabilitation', muscles: ['fingers'] }
            ],
            upperBody: [
                { name: 'Weighted Pull-ups', difficulty: 'intermediate', muscles: ['lats', 'biceps', 'forearms'] },
                { name: 'Lock-off Training', difficulty: 'intermediate', muscles: ['lats', 'biceps'] },
                { name: 'Frenchies (Pull-up Holds)', difficulty: 'intermediate', muscles: ['lats', 'biceps', 'core'] },
                { name: 'Typewriter Pull-ups', difficulty: 'advanced', muscles: ['lats', 'shoulders', 'core'] },
                { name: 'Muscle-ups', difficulty: 'advanced', muscles: ['lats', 'shoulders', 'chest'] },
                { name: 'Shoulder Stability Work', difficulty: 'beginner', muscles: ['shoulders', 'rotator_cuff'] },
                { name: 'Antagonist Training (Push)', difficulty: 'beginner', muscles: ['chest', 'triceps', 'shoulders'] }
            ],
            core: [
                ...
                { name: 'Hanging Leg Raises', difficulty: 'intermediate', muscles: ['core', 'hip_flexors'] },
                { name: 'Plank Variations', difficulty: 'beginner', muscles: ['core'] },
                { name: 'Hollow Body Hold', difficulty: 'beginner', muscles: ['core'] }
            ],
            lowerBody: [
                { name: 'Weighted Step-ups', difficulty: 'intermediate', muscles: ['quadriceps', 'glutes'] },
                { name: 'Bulgarian Split Squats', difficulty: 'intermediate', muscles: ['quadriceps', 'glutes'] },
                { name: 'Calf Raises', difficulty: 'beginner', muscles: ['calves'] },
                { name: 'Hip Mobility Work', difficulty: 'beginner', muscles: ['hip_flexors', 'glutes'] },
                { name: 'Pistol Squats', difficulty: 'advanced', muscles: ['quadriceps', 'glutes', 'core'] }
            ],
            flexibility: [
                ...
                { name: 'Pigeon Pose Variations', difficulty: 'beginner', muscles: ['hip_flexors', 'glutes'] }
            ]
        };
    }
    ...
    propose({ user, season, schedule, history, readiness, preferences }) {
        ...
        proposal.priorities = [
            { priority: 1, goal: `${climbingStyle} performance`, weight: 0.30 },
            { priority: 2, goal: 'Injury prevention (fingers/elbows)', weight: 0.25 },
            { priority: 3, goal: 'Grip strength development', weight: 0.20 }
        ];

...
const UserDataRetentionManager = require('./user-data-retention');
        ...
        switch (action) {
            ...
            default:
                return {
                    ...
                    headers,
                    body: JSON.stringify({
                        error: 'Invalid action. Supported actions: get_settings, update_settings, process_retention, delete_account'
                    })
                };
        }

  ...
  v_taper: {
    primary: [
      ...
      },
      {
        ...
        sets: 4,
        reps: '10-12',
        rationale: 'Wide lats for V-taper',
      },
      {
        name: 'Lateral Raises',
        category: 'shoulders',
      ...
      },
      {
        ...
        sets: 3,
        reps: '12-15',
        rationale: 'Posterior delts balance',
      },
    ],
    secondary: [
  ...
  toned: {
    primary: [
      ...
      },
      {
        ...
        sets: 3,
        reps: '12-15',
        rationale: 'Fat loss and conditioning',
      },
      {
        name: 'Cable Flies',
        category: 'chest',
    ...
    primary: [
      {
        ...
        sets: 3,
        reps: '5 each side',
        rationale: 'Total body coordination',
      },
      {
        ...
        sets: 3,
        reps: '15-20',
        rationale: 'Hip power and conditioning',
      },
      {
        name: "Farmer's Walks",
        ...
        sets: 3,
        reps: 'distance',
        rationale: 'Functional strength',
      },
      {
        name: 'Pallof Press',
        category: 'core_anti-rotation',
        sets: 3,
        reps: '10-12',
...
function generateAestheticProgram(aestheticFocus, readinessLevel = 8, equipmentAvailable = []) {
  ...
  const primaryAccessories = accessoryConfig.primary.map(acc => ({
    ...acc,
    adjustedSets: shouldReduceAccessories
      ? Math.max(1, Math.floor(acc.sets * volumeMultiplier))
      : acc.sets,
  }));
  ...
  return {
    ...
    secondaryAccessories:
      secondaryAccessories.length > 0 ? filteredAccessories.slice(primaryAccessories.length) : [],
...
function filterByEquipment(accessories, equipmentAvailable) {
  ...
  return accessories.filter(acc => {
    ...
    return equipmentAvailable.some(
      equip =>

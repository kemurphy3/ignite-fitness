...
async function testLintingComprehensive() {
    ...
    try {
        ...
        if (!consoleLogUsage) {
            ...
            ciComprehensiveResults.failed++;
            ciComprehensiveResults.errors.push('console.log usage detected - should be removed in production');
        }
        ...
        if (!debuggerUsage) {
            ...
            ciComprehensiveResults.failed++;
            ciComprehensiveResults.errors.push('debugger statements detected - should be removed in production');
        }
...
function displayComprehensiveCITestResults() {
    ...
    const passRate = totalTests > 0 ? (ciComprehensiveResults.passed / totalTests * 100).toFixed(1) : 0;

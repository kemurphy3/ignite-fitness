...
function calculateNutrition(gender, age, weight, height, activityLevel, dayType, sport, bodyFat, goals, weeklyLoad) {
    ...
    const carbGrams = dayType === 'game' 
        ? Math.round(remainingCalories * 0.65 / 4)
        : Math.round(remainingCalories * 0.50 / 4);

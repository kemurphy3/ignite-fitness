...
const API_ENDPOINTS = ['/.netlify/functions/', '/api/'];

// Workout data patterns
const WORKOUT_PATTERNS = ['/api/workouts/', '/api/exercises/', '/api/plans/'];
    ...
    caches
      ...
      .then(cacheNames => {
        ...
        const oldCaches = cacheNames.filter(
          cacheName => !currentCaches.includes(cacheName) && cacheName.startsWith('ignite-fitness')
        );
